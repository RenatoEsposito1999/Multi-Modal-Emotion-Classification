...
def val_epoch_multimodal(EEGData_val, epoch, data_loader, model, criterion, opt, logger,modality='both',dist=None):
    ...
    for i, item1 in enumerate(data_loader):
        ...
        logits_output  = model(inputs_audio, inputs_visual, EEG_inputs)
